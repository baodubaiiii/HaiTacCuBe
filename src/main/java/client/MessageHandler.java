...
public class MessageHandler {
    ...
    public void process_msg(Message m) throws IOException {
        System.out.print("---------- > REQUEST MSG: " + m.cmd + "\n");
        switch (m.cmd) {
            case 66: {
            ...
            case -52:
                ...
                System.out.print("MSG CLAN -52 TYPE: "+ type);
                switch(type){
                    case 10:
    ...
    public void login(Message m2) throws IOException {
        ...
        //
        String notice = "Hải Tặc War : Chào mừng đến với server Hải Tặc Tí Hon War , Số Người Online : "
