...
public class UpgradeItem {
    ...
    public static int[] beri = new int[]{3000000, 3200000, 3500000, 4000000, 4500000, 4500000};
    public static int[] ruby = new int[]{80, 80, 80, 100, 100, 100};
        ...
        switch (type) {
            case 1:
                ...
                if (itW != null && itW.levelup >= 10 && itW.levelup < 15 && itW.level >= 30) {
                    ...
                    int beriNeed = beri[(int) (itW.level / 10) - 5];
                    int rubyNeed = ruby[(int) (itW.level / 10) - 5];
                    Message m = new Message(66);
            ...
            case 2:
                ...
                if (itW != null && itW.levelup >= 10 && itW.levelup < 15 && itW.level >= 30) {
                    ...
                    if (Util.isTrue((100 - tiLeRotCap) * (6 * numThienThach))) {
                        itW.levelup++;
                        if(itW.levelup > 15){
                            itW.levelup = 15;
                        }
